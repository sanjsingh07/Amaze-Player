...
package com.sanj.amaze.subfragments;
...
import com.sanj.amaze.activities.DonateActivity;
...
public class SubStyleSelectorFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        switch (getArguments().getInt(ARG_PAGE_NUMBER)) {
            case 0:
                styleImage.setImageResource(R.drawable.amaze_1_nowplaying_x);
                break;
            case 1:
                styleImage.setImageResource(R.drawable.amaze_2_nowplaying_x);
                break;
            case 2:
                styleImage.setImageResource(R.drawable.amaze_3_nowplaying_x);
                break;
            case 3:
                styleImage.setImageResource(R.drawable.amaze_4_nowplaying_x);
                break;
            case 4:
                styleImage.setImageResource(R.drawable.amaze_5_nowplaying_x);
                break;
            case 5:
    ...
    public void setCurrentStyle() {
        String fragmentID = preferences.getString(Constants.NOWPLAYING_FRAGMENT_ID, Constants.amaze3);
    ...
    private String getStyleForPageNumber() {
        switch (getArguments().getInt(ARG_PAGE_NUMBER)) {
            case 0:
                return Constants.amaze1;
            case 1:
                return Constants.amaze2;
            case 2:
                return Constants.amaze3;
            case 3:
                return Constants.amaze4;
            case 4:
