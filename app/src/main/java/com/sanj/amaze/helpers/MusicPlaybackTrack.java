...
public class MusicPlaybackTrack implements Parcelable {
    ...
    public amazeUtils.IdType mSourceType;
    public int mSourcePosition;

    public MusicPlaybackTrack(long id, long sourceId, amazeUtils.IdType type, int sourcePosition) {
        mId = id;
        mSourceId = sourceId;
        mSourceType = type;
    ...
    public MusicPlaybackTrack(Parcel in) {
        ...
        mSourceType = amazeUtils.IdType.getTypeById(in.readInt());
