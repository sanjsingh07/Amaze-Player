...
/**
 * Created by Sanj Singh on 31/10/16.
 */
public class PlaylistAdapter extends RecyclerView.Adapter<PlaylistAdapter.ItemHolder> {
    ...
    public void onBindViewHolder(final ItemHolder itemHolder, int i) {
                            ...
                            new Palette.Builder(loadedImage).generate(new Palette.PaletteAsyncListener() {
                                ...
                                public void onGenerated(Palette palette) {
                                    ...
                                    if (swatch != null) {
                                        ...
                                        int textColor = amazeUtils.getBlackWhiteColor(swatch.getTitleTextColor());
                                        ...
                                        if (mutedSwatch != null) {
                                            ...
                                            itemHolder.footer.setBackgroundColor(color);
                                            int textColor = amazeUtils.getBlackWhiteColor(mutedSwatch.getTitleTextColor());
                                            itemHolder.title.setTextColor(textColor);
                                            itemHolder.artist.setTextColor(textColor);
                                        }
                                    }
        ...
        itemHolder.artist.setText(" " + String.valueOf(songCountInt) + " " + mContext.getString(R.string.songs) + " - " + amazeUtils.makeShortTimeString(mContext,totalRuntime));
                ...
                switch (position) {
                    case 0:
                        ...
                        if (songCountInt != 0) {
                            ...
                            return amazeUtils.getAlbumArtUri(firstAlbumID).toString();
                        } else return "nosongs";
                    case 1:
