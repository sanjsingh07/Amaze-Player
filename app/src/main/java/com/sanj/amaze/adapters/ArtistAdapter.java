...
public class ArtistAdapter extends RecyclerView.Adapter<ArtistAdapter.ItemHolder> implements BubbleTextGetter {
    ...
    public void onBindViewHolder(final ItemHolder itemHolder, int i) {
        ...
        String albumNmber = amazeUtils.makeLabel(mContext, R.plurals.Nalbums, localItem.albumCount);
        String songCount = amazeUtils.makeLabel(mContext, R.plurals.Nsongs, localItem.songCount);
        itemHolder.albums.setText(amazeUtils.makeCombinedString(mContext, albumNmber, songCount));
