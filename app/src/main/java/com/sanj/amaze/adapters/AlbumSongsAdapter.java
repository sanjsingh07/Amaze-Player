...
public class AlbumSongsAdapter extends BaseSongAdapter<AlbumSongsAdapter.ItemHolder> {
    ...
    public void onBindViewHolder(ItemHolder itemHolder, int i) {
        ...
        itemHolder.duration.setText(amazeUtils.makeShortTimeString(mContext, (localItem.duration) / 1000));
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            ...
                            case R.id.popup_song_delete:
                                ...
                                amazeUtils.showDeleteDialog(mContext,arraylist.get(position).title, deleteIds, AlbumSongsAdapter.this, position);
                                break;
                        }
                        return false;
                    }
