...
import com.sanj.amaze.adapters.SongsListAdapter;
import com.sanj.amaze.dataloaders.LastAddedLoader;
...
import com.sanj.amaze.dataloaders.TopTracksLoader;
...
import com.sanj.amaze.widgets.DragSortRecycler;
...
public class PlaylistDetailActivity extends BaseActivity implements ATEActivityThemeCustomizer, ATEToolbarCustomizer {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (animate && amazeUtils.isLollipop()) {
    ...
    private void setAlbumart() {
        ...
        loadBitmap(amazeUtils.getAlbumArtUri(getIntent().getExtras().getLong(Constants.ALBUM_ID)).toString());
    }
    ...
    private void clearAutoPlaylists() {
        switch (action) {
            case Constants.NAVIGATE_PLAYLIST_LASTADDED:
                amazeUtils.clearLastAdded(this);
                break;
            case Constants.NAVIGATE_PLAYLIST_RECENT:
                amazeUtils.clearRecent(this);
                break;
            case Constants.NAVIGATE_PLAYLIST_TOPTRACKS:
                amazeUtils.clearTopTracks(this);
                break;
        }
        Intent returnIntent = new Intent();
        setResult(Activity.RESULT_OK, returnIntent);
