...
import com.sanj.amaze.IamazeService;
...
import com.sanj.amaze.subfragments.QuickControlsFragment;
...
import static com.sanj.amaze.MusicPlayer.mService;
...
public class BaseActivity extends ATEActivity implements ServiceConnection, MusicStateListener {
    ...
    public void onServiceConnected(final ComponentName name, final IBinder service) {
        mService = IamazeService.Stub.asInterface(service);
        onMetaChanged();
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (!amazeUtils.hasEffectsPanel(BaseActivity.this)) {
