...
/**
 * Created by Sanj Singh on 29/10/16.
 */
public class DonateActivity extends BaseThemedActivity implements BillingProcessor.IBillingHandler {

    private static final String DONATION_1 = "sanj.amaze.donate_1";
    private static final String DONATION_2 = "sanj.amaze.donate_2";
    private static final String DONATION_3 = "sanj.amaze.donate_3";
    private static final String DONATION_5 = "sanj.amaze.donate_5";
    private static final String DONATION_10 = "sanj.amaze.donate_10";
    private static final String DONATION_20 = "sanj.amaze.donate_20";
