...
package com.sanj.amaze.activities;
...
import com.sanj.amaze.cast.ExpandedControlsActivity;
import com.sanj.amaze.cast.SimpleSessionManagerListener;
...
import com.sanj.amaze.fragments.FoldersFragment;
import com.sanj.amaze.fragments.MainFragment;
import com.sanj.amaze.fragments.PlaylistFragment;
import com.sanj.amaze.fragments.QueueFragment;
import com.sanj.amaze.permissions.Nammu;
import com.sanj.amaze.permissions.PermissionCallback;
import com.sanj.amaze.slidinguppanel.SlidingUpPanelLayout;
import com.sanj.amaze.subfragments.LyricsFragment;
...
import com.sanj.amaze.youtube.SearchActivity;
...
public class MainActivity extends BaseActivity implements ATEActivityThemeCustomizer {
    ...
    private void checkPermissionAndThenLoad() {
        ...
        if (Nammu.checkPermission(Manifest.permission.READ_EXTERNAL_STORAGE) && Nammu.checkPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            ...
            if (Nammu.shouldShowRequestPermissionRationale(this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                Snackbar.make(panelLayout, "amaze will need to read external storage to display songs on your device.",
    ...
    private void setupNavigationIcons(NavigationView navigationView) {
        ...
        if (!isDarkTheme) {
            ...
            navigationView.getMenu().findItem(R.id.nav_online_search).setIcon(R.drawable.youtube_dark);
            ...
            navigationView.getMenu().findItem(R.id.nav_online_search).setIcon(R.drawable.youtube_white);
    ...
    public void setDetailsToHeader() {
        ...
        ImageLoader.getInstance().displayImage(amazeUtils.getAlbumArtUri(MusicPlayer.getCurrentAlbumId()).toString(), albumart,
