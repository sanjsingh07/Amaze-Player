...
import com.sanj.amaze.adapters.BaseQueueAdapter;
import com.sanj.amaze.adapters.SlidingQueueAdapter;
import com.sanj.amaze.dataloaders.QueueLoader;
import com.sanj.amaze.listeners.MusicStateListener;
import com.sanj.amaze.timely.TimelyView;
...
import com.sanj.amaze.utils.SlideTrackSwitcher;
import com.sanj.amaze.utils.amazeUtils;
import com.sanj.amaze.widgets.CircularSeekBar;
import com.sanj.amaze.widgets.DividerItemDecoration;
import com.sanj.amaze.widgets.PlayPauseButton;
import com.sanj.amaze.widgets.PlayPauseDrawable;
...
public class BaseNowplayingFragment extends Fragment implements MusicStateListener {
        ...
        public void run() {
            ...
            if (mProgress != null) {
                ...
                if (elapsedtime != null && getActivity() != null)
                    elapsedtime.setText(amazeUtils.makeShortTimeString(getActivity(), position / 1000));
            }
            overflowcounter--;
    ...
    public Runnable mUpdateElapsedTime = new Runnable() {
        ...
        public void run() {
            if (getActivity() != null) {
                String time = amazeUtils.makeShortTimeString(getActivity(), MusicPlayer.position() / 1000);
                if (time.length() < 5) {
    ...
    public void setSongDetails(View view) {
        ...
        if (playPauseFloating != null) {
            playPauseDrawable.setColorFilter(amazeUtils.getBlackWhiteColor(accentColor), PorterDuff.Mode.MULTIPLY);
    ...
    public void updateSongDetails() {
        ...
        if (songduration != null && getActivity() != null)
            songduration.setText(amazeUtils.makeShortTimeString(getActivity(), MusicPlayer.duration() / 1000));
