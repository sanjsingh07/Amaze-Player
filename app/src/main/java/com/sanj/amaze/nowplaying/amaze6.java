...
import com.sanj.amaze.widgets.CircleImageView;

import net.steamcrafted.materialiconlib.MaterialDrawableBuilder;

/**
 * Created by Sanj Singh on 22/02/17.
 */

public class amaze6 extends BaseNowplayingFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(
                R.layout.fragment_amaze6, container, false);
    ...
    public void onMetaChanged() {
        ...
        if (getActivity() != null) {
            ...
            nextArt.setImageURI(amazeUtils.getAlbumArtUri(next.albumId));
        }
    }
}
