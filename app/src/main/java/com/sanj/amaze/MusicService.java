...
import com.sanj.amaze.helpers.MediaButtonIntentReceiver;
import com.sanj.amaze.helpers.MusicPlaybackTrack;
import com.sanj.amaze.lastfmapi.LastFmClient;
import com.sanj.amaze.lastfmapi.models.LastfmUserSession;
import com.sanj.amaze.lastfmapi.models.ScrobbleQuery;
import com.sanj.amaze.permissions.Nammu;
import com.sanj.amaze.provider.MusicPlaybackState;
import com.sanj.amaze.provider.RecentStore;
import com.sanj.amaze.provider.SongPlayCount;
import com.sanj.amaze.utils.NavigationUtils;
import com.sanj.amaze.utils.PreferencesUtility;
import com.sanj.amaze.utils.amazeUtils;
import com.sanj.amaze.utils.amazeUtils.IdType;
...
public class MusicService extends Service {
    public static final String PLAYSTATE_CHANGED = "com.sanj.amaze.playstatechanged";
    public static final String POSITION_CHANGED = "com.sanj.amaze.positionchanged";
    public static final String META_CHANGED = "com.sanj.amaze.metachanged";
    public static final String QUEUE_CHANGED = "com.sanj.amaze.queuechanged";
    public static final String PLAYLIST_CHANGED = "com.sanj.amaze.playlistchanged";
    public static final String REPEATMODE_CHANGED = "com.sanj.amaze.repeatmodechanged";
    public static final String SHUFFLEMODE_CHANGED = "com.sanj.amaze.shufflemodechanged";
    public static final String TRACK_ERROR = "com.sanj.amaze.trackerror";
    public static final String amaze_PACKAGE_NAME = "com.sanj.amaze";
    public static final String MUSIC_PACKAGE_NAME = "com.android.music";
    public static final String SERVICECMD = "com.sanj.amaze.musicservicecommand";
    public static final String TOGGLEPAUSE_ACTION = "com.sanj.amaze.togglepause";
    public static final String PAUSE_ACTION = "com.sanj.amaze.pause";
    public static final String STOP_ACTION = "com.sanj.amaze.stop";
    public static final String PREVIOUS_ACTION = "com.sanj.amaze.previous";
    public static final String PREVIOUS_FORCE_ACTION = "com.sanj.amaze.previous.force";
    public static final String NEXT_ACTION = "fcom.sanj.amaze.next";
    public static final String REPEAT_ACTION = "com.sanj.amaze.repeat";
    public static final String SHUFFLE_ACTION = "com.sanj.amaze.shuffle";
    public static final String FROM_MEDIA_BUTTON = "frommediabutton";
    public static final String REFRESH = "com.sanj.amaze.refresh";
    public static final String UPDATE_LOCKSCREEN = "com.sanj.amaze.updatelockscreen";
    ...
    public static final String CHANNEL_ID = "amaze_channel_01";
    ...
    private static final String SHUTDOWN = "com.sanj.amaze.shutdown";
    ...
    private void setUpMediaSession() {
        mSession = new MediaSessionCompat(this, "amaze");
    ...
    private void addToPlayList(final long[] list, int position, long sourceId, amazeUtils.IdType sourceType) {
    ...
    private void doAutoShuffleUpdate() {
        ...
        for (int i = 0; i < toAdd; i++) {
            ...
            mPlaylist.add(new MusicPlaybackTrack(mAutoShuffleList[idx], -1, amazeUtils.IdType.NA, -1));
            notify = true;
        }
        if (notify) {
            notifyChange(QUEUE_CHANGED);
    ...
    private void notifyChange(final String what) {
        ...
        musicIntent.setAction(what.replace(amaze_PACKAGE_NAME, MUSIC_PACKAGE_NAME));
        ...
        if (mRemoteControlClient != null) {
            ...
            if (what.equals(META_CHANGED) || what.equals(QUEUE_CHANGED)) {
                ...
                if (mShowAlbumArtOnLockscreen) {
                    albumArt = ImageLoader.getInstance().loadImageSync(amazeUtils.getAlbumArtUri(getAlbumId()).toString());
                    if (albumArt != null) {
    ...
    private void createNotificationChannel() {
        if (amazeUtils.isOreo()) {
            CharSequence name = "amaze";
    ...
    private Notification buildNotification() {
        ...
        Bitmap artwork;
        artwork = ImageLoader.getInstance().loadImageSync(amazeUtils.getAlbumArtUri(getAlbumId()).toString());
        ...
        if (artwork != null && amazeUtils.isLollipop()) {
            ...
            if (c != null && c.getCount() != 0) {
                ...
                do {
                    TrackItem t = new TrackItem()
                            .setArt(amazeUtils.getAlbumArtUri(c.getLong(c.getColumnIndexOrThrow(AudioColumns.ALBUM_ID))))
                            ...
                            .setDuration(amazeUtils.makeShortTimeString(this, c.getInt(c.getColumnIndexOrThrow(AudioColumns.DURATION)) / 1000));
                    list.add(t.get());
                } while (c.moveToNext());
                try {
                ...
                try {
                    if (mCursor != null && shouldAddToPlaylist) {
                        ...
                        mPlaylist.add(new MusicPlaybackTrack(
                                mCursor.getLong(IDCOLIDX), -1, amazeUtils.IdType.NA, -1));
                        notifyChange(QUEUE_CHANGED);
                        mPlayPos = 0;
                        mHistory.clear();
                    }
    ...
    public void open(final long[] list, final int position, long sourceId, amazeUtils.IdType sourceType) {
        synchronized (this) {
            if (mShuffleMode == SHUFFLE_AUTO) {
...
//            }
    ...
    private static final class ServiceStub extends IamazeService.Stub {
