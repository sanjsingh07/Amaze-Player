...
public class Helpers {
    ...
    public static class AboutDialog extends DialogFragment {
        ...
        String urltwitter = "https://twitter.com/sanjsingh07";
        String urlgithub = "https://github.com/sanjsingh07";
        String urlpatreon = "https://www.patreon.com/sanjsingh07";
        String urlsource = "https://github.com/sanjsingh07/amaze/issues";
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            TextView googleplus = aboutBodyView.findViewById(R.id.patreon);
            ...
            googleplus.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    i.setData(Uri.parse(urlpatreon));
                    startActivity(i);
                }
            ...
            try {
                ...
                appversion.setText("amaze " + version);
