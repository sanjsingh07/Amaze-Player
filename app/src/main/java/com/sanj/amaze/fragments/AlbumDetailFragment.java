 ...
 */
package com.sanj.amaze.fragments;
...
import com.sanj.amaze.adapters.AlbumSongsAdapter;
import com.sanj.amaze.dataloaders.AlbumLoader;
import com.sanj.amaze.dataloaders.AlbumSongLoader;
import com.sanj.amaze.dialogs.AddPlaylistDialog;
import com.sanj.amaze.listeners.SimplelTransitionListener;
import com.sanj.amaze.models.Album;
import com.sanj.amaze.models.Song;
import com.sanj.amaze.utils.ATEUtils;
import com.sanj.amaze.utils.Constants;
import com.sanj.amaze.utils.FabAnimationUtils;
import com.sanj.amaze.utils.Helpers;
...
import com.sanj.amaze.utils.SortOrder;
import com.sanj.amaze.utils.amazeUtils;
import com.sanj.amaze.widgets.DividerItemDecoration;
...
public class AlbumDetailFragment extends Fragment {
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        MusicPlayer.playAll(getActivity(), adapter.getSongIds(), 0, albumID, amazeUtils.IdType.Album, true);
        ...
        ImageUtils.loadAlbumArtIntoView(album.id, albumArt, new ImageLoadingListener() {
                    ...
                    public void onLoadingFailed(String imageUri, View view, FailReason failReason) {
                        ...
                        MaterialDrawableBuilder builder = MaterialDrawableBuilder.with(context)
                                ...
                                .setColor(amazeUtils.getBlackWhiteColor(Config.accentColor(context, Helpers.getATEKey(context))));
                                                                          ...
                                                                          public void onGenerated(Palette palette) {
                                                                              ...
                                                                              if (getActivity() != null) {
                                                                                  MaterialDrawableBuilder builder = MaterialDrawableBuilder.with(getActivity())
                                                                                          ...
                                                                                          .setSizeDp(30);
                                                                                  if (primaryColor != -1) {
                                                                                      builder.setColor(amazeUtils.getBlackWhiteColor(primaryColor));
                                                                                      ATEUtils.setFabBackgroundTint(fab, primaryColor);
                                                                                      fab.setImageDrawable(builder.build());
                                                                                  } else {
                                                                                      if (context != null) {
                                                                                          ATEUtils.setFabBackgroundTint(fab, Config.accentColor(context, Helpers.getATEKey(context)));
                                                                                          builder.setColor(amazeUtils.getBlackWhiteColor(Config.accentColor(context, Helpers.getATEKey(context))));
                                                                                          fab.setImageDrawable(builder.build());
                                                                                      }
                                                                                  }
                                                                              }
    ...
    private void setAlbumDetails() {
        ...
        String songCount = amazeUtils.makeLabel(getActivity(), R.plurals.Nsongs, album.songCount);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.popup_song_addto_queue:
                MusicPlayer.addToQueue(context, mAdapter.getSongIds(), -1, amazeUtils.IdType.NA);
                break;
